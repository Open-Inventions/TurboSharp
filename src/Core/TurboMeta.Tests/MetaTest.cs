...
namespace TurboMeta.Tests
{
    ...
    {
        [Theory]
        [InlineData("single/mincon.zip", "mincon.cs", 1, 0, 0, 0, 0, "mincon", 1, 17)]
        [InlineData("single/mincon.zip", "mincon.vb", 1, 0, 0, 0, 0, "mincon", 1, 17)]
        [InlineData("single/askname.zip", "askname.cs", 1, 0, 0, 0, 0, "askname", 1, 91)]
        [InlineData("single/askname.zip", "askname.vb", 1, 0, 0, 0, 0, "askname", 1, 91)]
        [InlineData("single/weather.zip", "weather.cs", 1, 0, 2, 0, 0, "weather", 1, 47)]
        [InlineData("single/weather.zip", "weather.vb", 1, 0, 2, 0, 0, "weather", 1, 47)]
        [InlineData("single/xmly.zip", "app.cs", 1, 1, 0, 0, 1, "app", 2, 175, true)]
        [InlineData("single/xmly.zip", "app.vb", 1, 1, 0, 0, 1, "app", 2, 175, true)]
        [InlineData("multi/Resty.zip", "Resty.sln", 2, 0, 4, 0, 0, "RestyC RestyV", 2, 47)]
        [InlineData("multi/Resty.zip", "RestyC/RestyC.csproj", 1, 0, 2, 0, 0, "RestyC", 1, 47)]
        [InlineData("multi/Resty.zip", "RestyV/RestyV.vbproj", 1, 0, 2, 0, 0, "RestyV", 1, 47)]
        [InlineData("multi/Xmly.zip", "Xmly.sln", 5, 2, 0, 2, 0, "XmlyC XmlyC.Model XmlyV XmlyV.Model Xmly.Embed", 9, 175, true, "Exe Lib")]
        ...
        [InlineData("multi/Xmly.zip", "XmlyC/XmlyC.csproj", 2, 1, 0, 1, 0, "XmlyC XmlyC.Model", 4, 175, true, "Exe Lib")]
        [InlineData("multi/Xmly.zip", "XmlyV.Model/XmlyV.Model.vbproj", 1, 0, 0, 0, 0, "XmlyV.Model", 3, null, false, "Lib")]
        [InlineData("multi/Xmly.zip", "XmlyV/XmlyV.vbproj", 2, 1, 0, 1, 0, "XmlyV XmlyV.Model", 4, 175, true, "Exe Lib")]
